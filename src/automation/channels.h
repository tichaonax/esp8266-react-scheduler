...
#define CHANNEL_THREE_DEFAULT_CONTROL_START_TIME_MINUTE 30
...
#define CHANNEL_THREE_DEFAULT_SPAN_TIME 1.5f    //hotTime hours
#define CHANNEL_THREE_DEFAULT_OVERRIDE_TIME 30.0f // override time in minutes
