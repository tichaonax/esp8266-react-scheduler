...
#define CHANNEL_TWO_DEFAULT_CONTROL_START_TIME_HOUR 17
#define CHANNEL_TWO_DEFAULT_CONTROL_START_TIME_MINUTE 30
#define CHANNEL_TWO_DEFAULT_CONTROL_END_TIME_HOUR 4
#define CHANNEL_TWO_DEFAULT_CONTROL_END_TIME_MINUTE 30
#define CHANNEL_TWO_DEFAULT_ENABLED_STATE true
#define CHANNEL_TWO_DEFAULT_ENABLE_TIME_SPAN_SCHEDULE false
#define CHANNEL_TWO_DEFAULT_RANDOMIZE_SCHEDULE true
#define CHANNEL_TWO_DEFAULT_SPAN_TIME 4.0f
#define CHANNEL_TWO_DEFAULT_OVERRIDE_TIME 120.0f // override time in minutes
...
#define CHANNEL_THREE_DEFAULT_SPAN_TIME 4.0f
