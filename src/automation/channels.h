...
#define CHANNEL_ONE_DEFAULT_NAME "Workshop Light" //  defaultChannelName
#define CHANNEL_ONE_CONFIG_JSON_PATH "/config/channelOneState.json"  // channelJsonConfigPath
#define CHANNEL_ONE_HOME_ASSISTANT_ENTITY "workshop_light"
#define CHANNEL_ONE_DEFAULT_CONTROL_RUN_EVERY 10
...
#define CHANNEL_ONE_DEFAULT_CONTROL_END_TIME_HOUR 19
