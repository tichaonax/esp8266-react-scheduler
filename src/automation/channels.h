...
#define CHANNEL_THREE_DEFAULT_NAME "Living Room Lights" //  defaultChannelName
...
#define CHANNEL_THREE_DEFAULT_CONTROL_RUN_EVERY 25
#define CHANNEL_THREE_DEFAULT_CONTROL_OFF_AFTER 5
#define CHANNEL_THREE_DEFAULT_CONTROL_START_TIME_HOUR 7
...
#define CHANNEL_THREE_DEFAULT_SPAN_TIME 14
