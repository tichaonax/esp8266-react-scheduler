...
#define CHANNEL_ONE_DEFAULT_OVERRIDE_TIME 0.25f // override time 15minutes
...
#define CHANNEL_TWO_DEFAULT_OVERRIDE_TIME 1.0f // override time one hour
...
#define CHANNEL_THREE_DEFAULT_OVERRIDE_TIME 2.0f // override time two hours
