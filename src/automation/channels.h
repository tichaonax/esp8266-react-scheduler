...
#define CHANNEL_THREE_DEFAULT_CONTROL_RUN_EVERY 30
#define CHANNEL_THREE_DEFAULT_CONTROL_OFF_AFTER 10
#define CHANNEL_THREE_DEFAULT_CONTROL_START_TIME_HOUR 2
#define CHANNEL_THREE_DEFAULT_CONTROL_START_TIME_MINUTE 0
#define CHANNEL_THREE_DEFAULT_CONTROL_END_TIME_HOUR 1
