...
#define CHANNEL_THREE_DEFAULT_NAME "Bathroom Light" //  defaultChannelName
...
#define CHANNEL_THREE_DEFAULT_CONTROL_END_TIME_HOUR 10
...
#define CHANNEL_THREE_DEFAULT_SPAN_TIME 1.5f
