...
#define CHANNEL_THREE_DEFAULT_NAME "Mary Firepit" //  defaultChannelName
...
#define CHANNEL_THREE_DEFAULT_CONTROL_RUN_EVERY 60.0f
...
#define CHANNEL_THREE_DEFAULT_CONTROL_END_TIME_HOUR 20
