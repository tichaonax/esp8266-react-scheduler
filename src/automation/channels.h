...
#define CHANNEL_THREE_DEFAULT_NAME "Main Fishpond Light" //  defaultChannelName
...
#define CHANNEL_THREE_DEFAULT_CONTROL_END_TIME_HOUR 21
...
#define CHANNEL_THREE_DEFAULT_SPAN_TIME 2.0f    //hotTime hours
