...
#define CHANNEL_ONE_DEFAULT_NAME "Irrigation Pump" //  defaultChannelName
...
#define CHANNEL_ONE_DEFAULT_CONTROL_OFF_AFTER 8.0f
...
#define CHANNEL_ONE_DEFAULT_OVERRIDE_TIME 35.0f // override time in minutes
