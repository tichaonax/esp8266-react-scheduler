...
#define CHANNEL_ONE_DEFAULT_NAME "Reading Light" //  defaultChannelName
...
#define CHANNEL_ONE_DEFAULT_CONTROL_END_TIME_HOUR 5
...
#define CHANNEL_ONE_HOMEASSISTANT_TOPIC_TYPE HOMEASSISTANT_TOPIC_TYPE_LIGHT
