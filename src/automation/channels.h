...
#define CHANNEL_TWO_DEFAULT_NAME "Sinilink AC Relay" //  defaultChannelName
...
#define CHANNEL_TWO_DEFAULT_CONTROL_START_TIME_HOUR 1
#define CHANNEL_TWO_DEFAULT_CONTROL_START_TIME_MINUTE 0
#define CHANNEL_TWO_DEFAULT_CONTROL_END_TIME_HOUR 0
#define CHANNEL_TWO_DEFAULT_CONTROL_END_TIME_MINUTE 55
...
#define CHANNEL_TWO_DEFAULT_ENABLE_MINIMUM_RUN_TIME_SCHEDULE true
