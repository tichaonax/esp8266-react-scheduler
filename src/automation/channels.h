...
#define CHANNEL_THREE_DEFAULT_NAME "Moblie Light" //  defaultChannelName
#define CHANNEL_THREE_CONFIG_JSON_PATH "/config/channelThreeState.json"  // channelJsonConfigPath
#define CHANNEL_THREE_HOME_ASSISTANT_ENTITY "mobile_light"    // homeAssistantEntity
