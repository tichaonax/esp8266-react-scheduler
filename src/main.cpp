...
TaskScheduler *channelOneTaskScheduler = new TaskScheduler(&server,
...
TaskScheduler *channelTwoTaskScheduler = new TaskScheduler(&server,
                                                           esp8266React.getSecurityManager(),
                                                           esp8266React.getMqttClient(),
                                                           &SPIFFS,
...
TaskScheduler *channelThreeTaskScheduler = new TaskScheduler(&server,
                                                             esp8266React.getSecurityManager(),
                                                             esp8266React.getMqttClient(),
                                                             &SPIFFS,
...
TaskScheduler *channelFourTaskScheduler = new TaskScheduler(&server,
                                                            esp8266React.getSecurityManager(),
                                                            esp8266React.getMqttClient(),
                                                            &SPIFFS,
