    ...
    return (
      <SectionContent title='Automation Information' titleGutter>
        <Typography variant="body1" paragraph>
          This simple app allows you to control two channels through a schedule. Due to the 
          resources limitations of the ESP8266 chip, only two channels are currently supported. There is
          a possibility that due to this only a single channel may be supported in the future.
        </Typography>
        <Typography variant="body1" paragraph>
        ...
        <Typography variant="body1" paragraph>
          Channel refers to either of the two channels
        </Typography>        
        <List>
          <ListItem>
            <ListItemText
